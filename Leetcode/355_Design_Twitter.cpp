...
class Twitter {
    int timeCount;
    unordered_map<int, vector<vector<int>>> tweetMap; // <userId, <timeCount, tweetId>>
    unordered_map<int, set<int>> followMap; // <userId, set of followees>
...
public:
    ...
    void postTweet(int userId, int tweetId) {
        tweetMap[userId].push_back({timeCount++, tweetId});
    }
